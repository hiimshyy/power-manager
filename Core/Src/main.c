...
int main(void)
{
  ...
  osThreadDef(sk60xTask, StartSK60xTask, osPriorityNormal, 0, 128);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_BMS_Pin|LED_SK_Pin|RL_CHG_Pin|RL_12V_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RL_5V_Pin|RL_3V3_Pin|FAULT_OUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_BMS_Pin LED_SK_Pin RL_CHG_Pin RL_12V_Pin */
  GPIO_InitStruct.Pin = LED_BMS_Pin|LED_SK_Pin|RL_CHG_Pin|RL_12V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : RL_5V_Pin RL_3V3_Pin FAULT_OUT_Pin */
  GPIO_InitStruct.Pin = RL_5V_Pin|RL_3V3_Pin|FAULT_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : INP_4_Pin INP_3_Pin */
  GPIO_InitStruct.Pin = INP_4_Pin|INP_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : INP_2_Pin INP_1_Pin */
  GPIO_InitStruct.Pin = INP_2_Pin|INP_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void StartDefaultTask(void const * argument)
{
  ...
  for(;;)
  {
	  ...
	  if (!relay_power_enabled && bms_data.voltage > voltage_threshold) {
	  	// Enable relay power rails when voltage
